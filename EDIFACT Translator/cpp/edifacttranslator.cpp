/*
 * IPWorks EDI 2022 C++ Edition - Demo Application
 *
	...
	if (ediTranslator.GetInputFormat() == 0) {
		...
		switch (atoi(prompt("Possible output format values are:\n0 - XML\n1 - JSON\n2 - EDIFACT\n3 - X12\n4 - TRADACOMS\n5 - VDA\n6 - HL7\nPlease select a value", ""))) {
			...
			case 2:
				...
				break;
			case 3:
				ediTranslator.SetOutputFormat(XOF_X12);
				break;
			case 4:
				ediTranslator.SetOutputFormat(TOF_TRADACOMS);
				break;
			case 5:
				ediTranslator.SetOutputFormat(VOF_VDA);
				break;
			case 6:
				ediTranslator.SetOutputFormat(HOF_HL7);
				break;
		}
	} else {
