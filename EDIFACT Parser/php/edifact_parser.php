...
<html>
<head>
<title>IPWorks EDI 2022 Demos - EDIFACT Parser</title>
<link rel="stylesheet" type="text/css" href="stylesheet.css">
<meta name="description" content="IPWorks EDI 2022 Demos - EDIFACT Parser">
</head>
...
<p>Shows how to parse EDIFACT documents via the ParseFile or Input methods.</p>
<a href="default.php">[Other Demos]</a>
<hr/>

<?php
require_once('../include/ipworksedi_edifactreader.php');
require_once('../include/ipworksedi_edifactwriter.php');
...
<?php
	$output='';
	class MyEdiReader extends IPWorksEDI_EDIFACTReader{
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
   ...
   try{
        ...
        $edireader1->doLoadSchema(getcwd() . "/RSSBus_D97A_INVOIC.json");
...
<div id="footer">
<center>
IPWorks EDI 2022 - Copyright (c) 2023 /n software inc. - All rights reserved. - For more information, please visit our website at <a href="http://www.nsoftware.com/?demopg-BEPHA" target="_blank">www.nsoftware.com</a>.
</center>
</div>
