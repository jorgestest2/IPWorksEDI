...
public class edifactparser extends ConsoleDemo {
  public static void main(String[] args) {
    ...
    try {
      ...
      edifactreader1.addEdifactreaderEventListener(new ipworksedi.DefaultEdifactreaderEventListener(){
     ...
     //edifactreader1.config("ResolveXPathOnSet=true");
      ...
      System.out.println("IPWorksEDI exception thrown: " + ex.getCode() + " [" + ex.getMessage() + "].");
    } catch (Exception ex) {
